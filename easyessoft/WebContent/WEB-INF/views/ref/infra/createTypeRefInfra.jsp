			...
			<div class="col-lg-14">
				<div class="panel panel-default">
					<div class="panel-heading">
						<h1 class="boderline">Création d'un type d'infrastructure</h1>
					</div>
					<div class="panel-body">
						<div class="box-content">
							<form:form id="typerefinfraForm" class="form-horizontal"
								method="post" action="/easyessoft/ihm/ref/typeRefInfra/create"
								commandName="typeRefInfra" onsubmit="return false;">
								<fieldset>
									<legend>Informations du type du référentiel d'infrastructure</legend>
									<p class="form-group">
