	...
	<div class="col-lg-14">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<label>Siret :${organization.siret}</label><br> <label>Finess
					:${organization.finess}</label><br>
				<div class="col-sm-4">
					<h2>Contacts</h2>
					<address>
						"${organization.streetNumber} ${organization.streetType}
						${organization.streetName}"<br> "${organization.zipCode}
						${organization.city}"<br> <abbr title="Phone">"${organization.phone}"</abbr>
						<abbr title="Fax">"${organization.fax}"</abbr> <abbr title="Email"><a
							href="mailto:${organization.email}">"${organization.email}"</a></abbr>
					</address>
				</div>
				<div class="col-sm-4">
