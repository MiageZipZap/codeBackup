								...
								<div id="messages-list" class="col-xs-10 col-xs-offset-2">
									...
									<div class="row one-list-message msg-inbox-item" id="msg-one">
										...
										<div class="col-xs-9 message-title">
											<b>Happy New Year</b> Dear friend! It's title of this message
											I send Dear friend! It's title of this message I send Dear
											friend! It's title of this message I send
										</div>
										<div class="col-xs-2 message-date">12/31/13</div>
									</div>
									<div class="row one-list-message msg-starred-item">
										<div class="col-xs-1 checkbox">
											<label> <input type="checkbox"> Linus T. <i
												class="fa fa-square-o small"></i>
											</label>
										</div>
										<div class="col-xs-9 message-title">
											<b>Announce new release</b> Hi. 3.11.xx is released!
										</div>
										<div class="col-xs-2 message-date">12/31/13</div>
									</div>
									<div class="row one-list-message msg-inbox-item">
										<div class="col-xs-1 checkbox">
											<label> <input type="checkbox"> Barry O. <i
												class="fa fa-square-o small"></i>
											</label>
										</div>
										<div class="col-xs-9 message-title">
											<b>All books is buyed</b> Very nice. I receive you invoice
											and pay.
										</div>
										<div class="col-xs-2 message-date">12/31/13</div>
									</div>
									<div class="row one-list-message">
										<div class="col-xs-1 checkbox">
											<label> <input type="checkbox"> Daniel D. <i
												class="fa fa-square-o small"></i>
											</label>
										</div>
										<div class="col-xs-9 message-title">
											<b>Great news!</b> Implemented a workaround for some
											interrupt buggy printers
										</div>
										<div class="col-xs-2 message-date">02/12/14</div>
									</div>
									<div class="row one-list-message msg-inbox-item">
										<div class="col-xs-1 checkbox">
											<label> <input type="checkbox"> John A. <i
												class="fa fa-square-o small"></i>
											</label>
										</div>
										<div class="col-xs-9 message-title">
											<b>New movie downloaded</b> Some new sysctl entries for the
											parport driver.
										</div>
										<div class="col-xs-2 message-date">12/31/13</div>
									</div>
									<div class="row one-list-message msg-starred-item">
										<div class="col-xs-1 checkbox">
											<label> <input type="checkbox"> Stephen R. <i
												class="fa fa-square-o small"></i>
											</label>
										</div>
										<div class="col-xs-9 message-title">
											<b>Specialisation:</b> tweaking, ensuring portability,
											tweaking, cleaning, tweaking and occasionally debugging :-)
										</div>
										<div class="col-xs-2 message-date">12/31/13</div>
									</div>
									<div class="row one-list-message msg-trash-item">
										<div class="col-xs-1 checkbox">
											<label> <input type="checkbox"> Zach B. <i
												class="fa fa-square-o small"></i>
											</label>
										</div>
										<div class="col-xs-9 message-title">
											<b>Congratulation!</b> You win 1000000$
										</div>
										<div class="col-xs-2 message-date">12/31/13</div>
									</div>
									<div class="row one-list-message msg-draft-item">
										<div class="col-xs-1 checkbox">
											<label> <input type="checkbox"> Larry K. <i
												class="fa fa-square-o small"></i>
											</label>
										</div>
										<div class="col-xs-9 message-title">
											<b>I lost you phone number</b> Please send it to my email!
										</div>
										<div class="col-xs-2 message-date">12/31/13</div>
									</div>
									<div class="row one-list-message msg-draft-item">
										<div class="col-xs-1 checkbox">
											<label> <input type="checkbox"> Kevin M. <i
												class="fa fa-square-o small"></i>
											</label>
										</div>
										<div class="col-xs-9 message-title">
											<b>You lost password</b> I may recover this for you.
										</div>
										<div class="col-xs-2 message-date">12/31/13</div>
									</div>
									<div class="row one-list-message msg-starred-item">
										<div class="col-xs-1 checkbox">
											<label> <input type="checkbox"> Peter N. <i
												class="fa fa-square-o small"></i>
											</label>
										</div>
										<div class="col-xs-9 message-title">
											<b>Time is over.</b> You need goes to Hollywood.
										</div>
										<div class="col-xs-2 message-date">12/31/13</div>
									</div>
									<div class="row one-list-message msg-inbox-item">
										<div class="col-xs-1 checkbox">
											<label> <input type="checkbox"> Alex L. <i
												class="fa fa-square-o small"></i>
											</label>
										</div>
										<div class="col-xs-9 message-title">
											<b>Mail from me</b> Read them carefully, as they tell you
									...
									<div class="row one-list-message msg-important-item">
										<div class="col-xs-1 checkbox">
											<label> <input type="checkbox"> Dave M. <i
												class="fa fa-square-o small"></i>
											</label>
										</div>
										<div class="col-xs-9 message-title">
											<b>Warning</b> To find out where to send an emailed bug
											report, find your subsystem
										</div>
										<div class="col-xs-2 message-date">02/11/14</div>
									</div>
									<div class="row one-list-message msg-important-item">
										<div class="col-xs-1 checkbox">
											<label> <input type="checkbox"> Alax K. <i
												class="fa fa-square-o small"></i>
											</label>
										</div>
										<div class="col-xs-9 message-title">
											<b>Info for you</b> Use that information to fill in all
											fields of the bug report form
										</div>
										<div class="col-xs-2 message-date">12/31/13</div>
									</div>
									<div class="row one-list-message msg-sent-item">
										<div class="col-xs-1 checkbox">
											<label> <input type="checkbox"> Kai W. <i
												class="fa fa-square-o small"></i>
											</label>
										</div>
										<div class="col-xs-9 message-title">
											<b>Good news.</b> Fix escaped markup in folder comparisons
										</div>
										<div class="col-xs-2 message-date">12/31/13</div>
									</div>
									<div class="row one-list-message msg-sent-item">
										<div class="col-xs-1 checkbox">
											<label> <input type="checkbox"> Steve O. <i
												class="fa fa-square-o small"></i>
											</label>
										</div>
										<div class="col-xs-9 message-title">
											<b>New work for you.</b> Requred translations for English,
											Dutch, Spanish, French, Slovak
										</div>
										...
										<div class="box">
											...
											<div class="page-feed-content">
												...
												<p>Linux is a Unix-like and POSIX-compliant computer
													...
													source software development and distribution. Maemo -
													Software platform developed by Nokia and then handed over
													to Hildon Foundation for smartphones and Internet tablets</p>
												<div class="likebox">
